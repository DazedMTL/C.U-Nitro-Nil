...
module WD_itemsynthesis_ini
  ...
  #武器の合成レシピ
  W_recipe[2]  = [400,   ["W",1,1], ["I",50,1]]
  W_recipe[22]  = [400,   ["W",21,1], ["I",50,1]]
  W_recipe[3]  = [800,   ["W",2,1], ["I",122,1]]
  W_recipe[23]  = [800,   ["W",22,1], ["I",122,1]]
  W_recipe[4]  = [1200,   ["W",3,1], ["I",123,1]]
  W_recipe[24]  = [1200,   ["W",23,1], ["I",123,1]]
  W_recipe[5]  = [1500,   ["W",4,1], ["I",124,1]]
  W_recipe[25]  = [1500,   ["W",24,1], ["I",124,1]]
   W_recipe[6]  = [2000,   ["W",5,1], ["I",125,1]]
  W_recipe[26]  = [2000,   ["W",25,1], ["I",125,1]]
...
class Window_ItemSynthesisChange < Window_Base
  ...
  def refresh
    contents.clear
    text = "Z: Material ⇔ Status Display Toggle"
